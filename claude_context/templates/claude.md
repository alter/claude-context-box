...
## SHORTCUTS
```
u → $(python3 .claude/get_python.py) .claude/update.py
c → $(python3 .claude/get_python.py) .claude/check.py
s → cat PROJECT.llm
h → $(python3 .claude/get_python.py) .claude/help.py
validate → $(python3 .claude/get_python.py) .claude/validation.py
deps → cat PROJECT.llm | grep -A20 "@dependency_graph"
ctx_init → $(python3 .claude/get_python.py) .claude/context.py init
ctx_update → $(python3 .claude/get_python.py) .claude/context.py update
cc → $(python3 .claude/get_python.py) .claude/cleancode.py --interactive
mcp → MCP_AUTO_SETUP=1 $(python3 .claude/get_python.py) .claude/mcp_setup.py
```
