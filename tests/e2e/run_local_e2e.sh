...
# ---- 6. Engine: PROJECT.llm + CONTEXT.llm populated by initial install -----
echo "==> initial install populated contexts"
[ -f "$TARGET/PROJECT.llm" ] || fail "PROJECT.llm not generated by initial install"
ok "PROJECT.llm generated by initial install"
